...
class QTester:
    ...
    def __init__( self , refreshRate = 300 ):
        ...
        self.qCmd.names    = [ 'head_pan' , 'right_j0' , 'right_j1' , 'right_j2' , 'right_j3' , 'right_j4' , 'right_j5' , 'right_j6' ]
    ...
    def run( self ):
        ...
        while ( not rospy.is_shutdown() ):
            ...
            qNu = [ self.qCmd.position[i] + self.Qspeed for i in range( len( self.qCmd.names ) ) ]
