...
class face():
    ...
    def callback(self, data):
        ...
        # converting into grayscale and detecting the faces, creating the bounding box and cropping the image using haar-cascade classifier
        gray = cv2.cvtColor(full_size_image, cv2.COLOR_BGR2GRAY)
        face = cv2.CascadeClassifier(self.CONFIG_DIR + 'haarcascade_frontalface_default.xml')
