class Data():
    def __init__(self, data_type):
        ...
        if data_type == "basic":
            ...
            self.faults = {
                "You failed in passing the ball4":  (('object', 'cup', 'angle', 'orientation/object'),"Do not flip the cup before passing the ball"), #2
                "You failed in passing the ball10":  (('object', 'cup', 'angle', 'orientation/object'),"The ball falls down when you flip the cup"), #2
                "You failed in passing the ball6":  (('object', 'cup', 'angle', 'orientation/object'),"Pass me the cup without flipping it"), #2
                "You failed in passing the ball3":  (('object', 'cup', 'angle', 'orientation/object'),"No need to flip the cup"), #2
                "You failed in passing the ball1":  (('object', 'cup', 'angle', 'orientation/object'),"Keep the cup upright"), #2
                "You failed in passing the ball9":  (('object', 'cup', 'angle', 'orientation/object'),"Ensure that the ball is always in the cup"), #1
                "You failed in passing the ball2":  (('object', 'cup', 'angle', 'orientation/object'),"Pass the cup so that I can take the ball"), #1
                "You failed in passing the ball7":  (('object', 'cup', 'angle', 'orientation/object'),"Pass me the ball without dropping it"), #0
                "You failed in passing the ball8":  (('object', 'cup', 'angle', 'orientation/object'),"Do not drop the ball"), #0
                "You failed in passing the ball5":  (('object', 'cup', 'angle', 'orientation/object'),"Pass me the ball"), #0
                "The pouring task is wrong2":  (('object', 'cup', 'container', 'above/object_object'),"You need to pour the cup above the container"), #2
                "The pouring task is wrong5":  (('object', 'cup', 'container', 'above/object_object'),"The container is to the left of the cup"), #2
                "The pouring task is wrong6":  (('object', 'cup', 'container', 'above/object_object'),"The container is not in the center of the table"), #1
                "The pouring task is wrong10":  (('object', 'cup', 'container', 'above/object_object'),"The ball should be dropped in the container"), #1
                "The pouring task is wrong8":  (('object', 'cup', 'container', 'above/object_object'),"You did not put the ball in the container"), #1
                "The pouring task is wrong7":  (('object', 'cup', 'container', 'above/object_object'),"Put the ball in the container"), #1
                "The pouring task is wrong4":  (('object', 'cup', 'container', 'above/object_object'),"The cup needs to be above it"), #1
                "The pouring task is wrong1":  (('object', 'cup', 'container', 'above/object_object'),"The container is over there"), #1
                "The pouring task is wrong3":  (('object', 'cup', 'container', 'above/object_object'),"The container is not there"), #1
                "The pouring task is wrong9":  (('object', 'cup', 'container', 'above/object_object'),"That is not where you drop the ball"), #0
                "Cleaning Task gone wrong5":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"Keep your distance from john with the cup"), #3
                "Cleaning Task gone wrong9":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"Keep more space between john and the cup"), #2
                "Cleaning Task gone wrong1":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"You almost hit john with the cup"), #2
                "Cleaning Task gone wrong7":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"You should be far from john"), #2
                "Cleaning Task gone wrong2":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"You were too close to john"), #2
                "Cleaning Task gone wrong4":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"Stay away from john"), #1
                "Cleaning Task gone wrong3":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"You scared john"), #1
                "Cleaning Task gone wrong10":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"You are not utilizing the common space properly"), #0
                "Cleaning Task gone wrong6":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"You should do the task near you"), #0
                "Cleaning Task gone wrong8":  (('robot', 'sawyer', 'human', 'john', 'distance', 'distance/robot_human'),"You did not do the task safely") #0
            }
        else:
